...
export const ERROR_CODES = {
  ...
  /**
   * کاربر باید ابتدا رمز اولیه خود را تغییر دهد (BR-26).
   * ۴۰۳ و نه ۴۰۱: نشست معتبر است، اما تا تغییر رمز هیچ مسیر دیگری مجاز نیست.
   * Frontend با دیدن این کد کاربر را به صفحهٔ تغییر رمز هدایت می‌کند.
   */
  AUTH_006: {
    code: 'AUTH_006',
    httpStatus: 403,
    message: 'برای ادامه، ابتدا باید رمز عبور خود را تغییر دهید',
  },
  ORDER_001: {
    code: 'ORDER_001',
    httpStatus: 404,
  ...
  /**
   * بخشی از سامانه که با Feature Flag موقتاً غیرفعال شده است.
   * ۴۰۳ (نه ۴۰۴) تا هم امنیت رعایت شود و هم پاسخ با قرارداد بخش ۱۶ سازگار بماند.
   */
  FEATURE_DISABLED: {
    code: 'FEATURE_DISABLED',
    httpStatus: 403,
    message: 'این بخش موقتاً غیرفعال است',
  },
  GENERIC_500: {
    code: 'GENERIC_500',
    httpStatus: 500,
